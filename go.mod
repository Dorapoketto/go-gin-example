module github.com/Dorapoketto/go-gin-example
...
replace (
	github.com/Dorapoketto/go-gin-example/conf => ./pkg/conf
	github.com/Dorapoketto/go-gin-example/middleware => ./middleware
	...
	github.com/Dorapoketto/go-gin-example/docs => ./docs
